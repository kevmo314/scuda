...
extern int rpc_start_request(int request);
extern int rpc_write(const void *buf, size_t count);
extern int rpc_read(void *buf, size_t count);
extern int rpc_wait_for_response(int request_id);
extern int rpc_end_request(int request_id, void *return_value);
